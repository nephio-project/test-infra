...
for nf in nrf udm udr ausf amf; do
    porch_wait_published_packagerev "oai-$nf" "core" "$REVISION"
...
porch_wait_published_packagerev "oai-upf" "edge" "$REVISION"
...
porch_wait_published_packagerev "oai-smf" "core" "$REVISION"
