...
## TEST METADATA
## TEST-NAME: Deploy a flux specific workload cluster
##
...
regional_pkg_rev=$(porchctl rpkg clone -n default "https://github.com/nephio-project/catalog.git/infra/capi/nephio-workload-cluster-flux@$REVISION" --repository mgmt regional | cut -f 1 -d ' ')
