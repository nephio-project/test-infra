...
regional_pkg_rev=$(kpt alpha rpkg clone -n default https://github.com/nephio-project/nephio-example-packages.git/nephio-workload-cluster@v9 --repository mgmt regional | cut -f 1 -d ' ')
